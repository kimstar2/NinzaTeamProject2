...
{
    public class DiceBattleManager : MonoBehaviour , IGetIsSelectService , IRequirePooling
    {
        ...
        private void Awake() => ServiceLocator.Register<IGetIsSelectService>(this);
        ...
        private void ConnectLine(DiceSelector getSelector)
        {
            ...
            lR = Instantiate(copyLineRenderer.LineRenderer, transform, true);
